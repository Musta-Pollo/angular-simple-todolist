...
@Component({
  ...
  standalone: true,
  imports: [ZardDividerComponent, ZardCardComponent, SidebarNavItemComponent, AppLogoComponent, FilterDropdownComponent, SearchFilterBarComponent, TaskCardComponent, EmptyTasksComponent, TaskListHeaderComponent, TaskFormComponent],
  template: `
          ...
          <z-card>
            <div class="p-4">
              ...
              <div class="space-y-2 text-sm">
                <p><span class="text-muted-foreground">Priority:</span> {{ currentFilter().priority }}</p>
                <p><span class="text-muted-foreground">Sort by:</span> {{ currentFilter().sortBy }}</p>
                <p><span class="text-muted-foreground">Descending:</span> {{ currentFilter().descending }}</p>
              </div>
            </div>
          </z-card>
        </div>
...
export class AppElementsPage {
  ...
  sampleTasks: Task[] = [
    { id: '1', title: 'Review project proposal', deadline: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000), priority: 'high', completed: false },
    { id: '2', title: 'Team meeting', deadline: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000), priority: 'medium', completed: false },
    { id: '3', title: 'Update documentation', deadline: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000), priority: 'low', completed: false },
